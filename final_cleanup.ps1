...
$content = Get-Content "c:\Users\geoff\Desktop\EcoCurieux\modele1_v2 (16).html" -Raw

# Remplacer toute la section hero-bg-bubbles par une version propre
$cleanSection = @"
...
# Utiliser une regex pour remplacer toute la section
$pattern = '(?s)<div class="hero-bg-bubbles">.*?</div>'
$content = $content -replace $pattern, $cleanSection

# Écrire le contenu nettoyé
$content | Set-Content "c:\Users\geoff\Desktop\EcoCurieux\modele1_v2 (16).html"
