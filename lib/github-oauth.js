...
export function getOAuthCreds(req) {
  return {
    clientId: process.env.GITHUB_CLIENT_ID || readCookie(req, COOKIE_ID),
    clientSecret: process.env.GITHUB_CLIENT_SECRET || readCookie(req, COOKIE_SECRET),
  };
}
